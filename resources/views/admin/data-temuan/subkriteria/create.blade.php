    ...
    <section class="content">
        <div class="crud-card">
            <div class="crud-card-header">
                <h5><i class="fas fa-folder-open"></i> Tambah Subkriteria: <strong>{{ $kriteria->nama }}</strong></h5>
                <a href="{{ route('admin.temuan.show', $kriteria->id) }}" class="btn-crud btn-crud-secondary btn-crud-sm">
                    ...
                    <div class="p-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="judul" class="form-control" placeholder="Masukkan judul subkriteria" required>
                            </div>
                        </div>
                        ...
                        <div id="container-hasil-temuan">
                            <div class="row mb-2 hasil-temuan-row align-items-center">
                                <div class="col-10">
                                    <input type="text" name="hasil_temuan[]" class="form-control" placeholder="Masukkan hasil temuan" required>
                                </div>
                                <div class="col-2">
