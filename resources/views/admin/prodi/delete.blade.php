...
<button role="button" class="btn-crud btn-crud-danger btn-crud-sm" data-bs-toggle="modal"
    data-bs-target=".formDelete{{ $prodi->id }}">
    <i class="fas fa-trash"></i> <span class="d-none d-sm-inline">Hapus</span>
</button>

<!-- Modal -->
<div class="modal fade formDelete{{ $prodi->id }} modal-crud modal-crud-delete" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-exclamation-triangle mr-2"></i>Hapus Prodi</h5>
