...
<button role="button" class="btn-crud btn-crud-danger btn-crud-sm" data-bs-toggle="modal"
    data-bs-target=".formDelete{{ $matkul->id }}">
    <i class="fas fa-trash"></i> <span class="d-none d-sm-inline">Hapus</span>
</button>

<!-- Modal -->
<div class="modal fade formDelete{{ $matkul->id }} modal-crud modal-crud-delete" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-exclamation-triangle mr-2"></i>Hapus Mata Kuliah</h5>
            ...
            <div class="modal-body text-center py-4">
                ...
                <p class="modal-desc">Mata kuliah <strong>{{ $matkul->nama_matkul }}</strong> akan dihapus permanen.</p>
            </div>
            <div class="modal-footer justify-content-center">
                <form action="{{ route('admin.matkul.destroy', $matkul->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
